...
/**
 * High-fidelity DS (DAAN Sports) brand emblem matching the reference design for Admin portal.
 */
export default function DsLogo({ className = "h-8 w-auto", textClassName = "text-white" }) {
  return (
    <div className="flex items-center gap-2 select-none">
      ...
      >
        <defs>
          <linearGradient id="dsAdminGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#FFFFFF" />
            <stop offset="60%" stopColor="#EDEDED" />
            <stop offset="100%" stopColor="#D4D4D8" />
          </linearGradient>
          <filter id="dsAdminShadow" x="-10%" y="-10%" width="120%" height="120%">
            <feDropShadow dx="0" dy="2" stdDeviation="3" floodColor="#000000" floodOpacity="0.4" />
          </filter>
        </defs>

        <g filter="url(#dsAdminShadow)">
